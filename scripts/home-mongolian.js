...
const pairs = [
  ...
  ['Customer Reviews', 'Хэрэглэгчийн сэтгэгдэл'],
  ...
  ['Anonymous A.', 'Мөнхсоёл'],
  ['Anonymous B.', 'Мөнхсоёл'],
  ['Anonymous C.', 'Мөнхсоёл'],
  ['"Secret Shop has the most premium quality products. The packaging, the details, everything is perfect. Highly recommended!"', '"Хэрэглэж үзсэн гоё эд байна"'],
  ['"Absolutely stunning collection. I ordered the Velvet Pulse Massager and I get compliments every single day. World-class service too."', '"Еооо гоё юмаа ахиад авнаа"'],
  ['"The leather bag I purchased exceeded all my expectations. The quality is unmatched. Secret Shop is my go-to for adult products now."', '"Таалагдлааа"'],
